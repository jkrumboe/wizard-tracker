...
export const RotateCcwIcon = (props) => <Icon name="RotateCcw" {...props} />;
...
export const UserPlusIcon = (props) => <Icon name="UserPlus" {...props} />;
export const FileTextIcon = (props) => <Icon name="FileText" {...props} />;
export const ArrowUpIcon = (props) => <Icon name="ArrowUp" {...props} />;
export const ArrowDownIcon = (props) => <Icon name="ArrowDown" {...props} />;
