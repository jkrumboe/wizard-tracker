...
- Follow the JavaScript/React style conventions
...
See the [Getting Started](Getting-Started) guide for detailed instructions on setting up your development environment.
